...
Example:
    JAX_PLATFORM=gpu HMC_WARMUP=500 HMC_SAMPLES=1000 PRED_MAX_SAMPLES=200 python hmc_inference.py
"""
...
def main():
    ...
    parser.add_argument("--warmup", type=int, default=int(os.environ.get("HMC_WARMUP", "1000")))
